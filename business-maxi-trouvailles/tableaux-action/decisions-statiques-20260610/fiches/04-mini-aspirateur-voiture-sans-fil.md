# Decision statique - Mini aspirateur voiture sans fil

Priorite: 4
Produit: prod_partner_car_vacuum_001
...
lien fournisseur non exact | SKU fournisseur manquant | images et droits non prouves | risques: controle_electrique_ou_batterie, controle_usage_auto

## Contexte fournisseur interne

- URL fournisseur interne: https://www.aliexpress.com/wholesale?SearchText=cordless+car+vacuum+cleaner
- URL exacte: non
- SKU fournisseur: a verifier
- Prix fournisseur: 22.00 EUR
- Prix boutique: 39.90 EUR
- Stock fournisseur: 15
...
```json
{
  ...
  "productName": "Mini aspirateur voiture sans fil",
  "checkedAt": "",
  "decision": "",
  "decisionOptions": [
    "keep_validate",
  ...
  "ifReplace": {
    ...
    "targetCategory": "dropshipping-auto-moto",
