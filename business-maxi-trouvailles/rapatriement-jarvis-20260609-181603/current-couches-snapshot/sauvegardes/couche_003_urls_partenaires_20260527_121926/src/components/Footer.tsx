...
const shopLinks = [
  ...
  { href: "/dropshipping", label: "Produits partenaires" },
...
const legalLinks = [
  ...
  { href: "/conditions-dropshipping", label: "Conditions produits partenaires" },
      ...
      <div className="container-page grid gap-8 py-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="max-w-md text-sm leading-6 text-white/70">
            Boutique de bonnes affaires et produits partenaires neufs. Les vrais
            produits seront ajoutes progressivement.
          </p>
        </div>
