...
const sections = [
  ...
  },
  {
    ...
    text: "Les delais affiches sont des estimations. Ils peuvent varier selon le fournisseur, le transporteur, la periode et les controles avant expedition.",
  },
  {
    title: "Suivi colis",
  ...
  },
  {
    ...
    text: "Au lancement, chaque commande fournisseur est preparee et validee manuellement afin d'eviter tout achat automatique non controle.",
  },
];
...
export default function DropshippingTermsPage() {
  return (
    <>
      <PageHeader
        eyebrow="Conditions"
