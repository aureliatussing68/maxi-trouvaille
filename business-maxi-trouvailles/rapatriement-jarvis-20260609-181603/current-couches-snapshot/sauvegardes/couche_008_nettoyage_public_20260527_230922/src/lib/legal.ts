    ...
    sections: [
      {
        title: "Objet",
        paragraphs: [
          "Les presentes conditions encadrent les ventes de produits proposes par Maxi Trouvaille : objets neufs ou quasi neufs, bonnes affaires et produits partenaires identifies comme tels.",
        ],
      },
      {
        title: "Produits",
