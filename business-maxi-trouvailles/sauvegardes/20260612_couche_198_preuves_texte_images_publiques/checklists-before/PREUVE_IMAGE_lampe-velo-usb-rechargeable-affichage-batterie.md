# Preuve image exacte - Lampe vélo USB rechargeable affichage batterie

Statut: HOLD - validation humaine requise

Produit: Lampe vélo USB rechargeable affichage batterie
Slug: lampe-velo-usb-rechargeable-affichage-batterie
Categorie: dropshipping-high-tech
Lane image: REMPLACER_IMAGE
Blocages image: image_remote_not_local, supplier_cdn_image, image_not_in_exact_product_depot, image_not_webp, image_rights_not_ready
Image actuelle: [image distante masquee]

## Cible WebP

- Chemin public apres validation: `/uploads/partner-products/lampe-velo-usb-rechargeable-affichage-batterie.webp`
- Chemin local apres validation: `public\uploads\partner-products\lampe-velo-usb-rechargeable-affichage-batterie.webp`
- Dossier de travail manuel: `business-maxi-trouvailles/preuves-images-publiques/lampe-velo-usb-rechargeable-affichage-batterie/depot-manuel`
- Nom attendu: `lampe-velo-usb-rechargeable-affichage-batterie.webp`
