...
La commande `catalog:daily-execution-board` rassemble les actions du jour: cockpit produit prioritaire, preuves produits partenaires, depots images categories, photos produits sprint, board Mouss images publiques, formulaire preuves texte images et garde-fous checkout/publication/surprises. Elle remonte aussi les compteurs WebP manquants, preuves texte a remplir, lignes de formulaire et fiches pretes revue, tout en restant en lecture seule.

La commande `catalog:audit-daily-execution-board` controle ce tableau avant de s'y fier: mode lecture seule, garde-fous sensibles, absence d'URL externe ou marqueur marketplace, actions images qui rappellent l'interdiction de copie publique/publication/commande, compteurs surface publique/checkout/surprises et copie image publique non appliquee.
