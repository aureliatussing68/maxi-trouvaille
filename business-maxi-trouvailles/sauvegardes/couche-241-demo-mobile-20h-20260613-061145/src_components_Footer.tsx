...
const shopLinks = [
  { href: "/produits-partenaires", label: "Dropshipping" },
  { href: "/categories/nouveautes-partenaires", label: "Nouveautés" },
  { href: "/categories/promotions-partenaires", label: "Promotions" },
      ...
      <div className="container-page grid gap-8 py-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          ...
          <p className="max-w-md text-sm leading-6 text-white/70">
            ...
            paiement Maxi Trouvaille, suivi colis et validation humaine au debut.
          </p>
        </div>
