  ...
  return (
    <>
      <PageHeader
        ...
        title="Boutique dropshipping Maxi Trouvaille"
      ...
      <section className="container-page border-b border-line py-8">
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <TrustItem
            ...
            text="Aucun achat partenaire automatique au début : les commandes restent contrôlées."
          />
        </div>
      </section>
      ...
      <section className="container-page pb-12">
        ...
        {highlightedProducts.length > 0 ? (
          ...
          <div className="rounded-lg border border-line bg-paper p-8 text-center shadow-sm">
            <h2 className="text-2xl font-black">Sélection dropshipping en validation</h2>
            <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-muted">
              Les produits partenaires sont préparés en coulisses. Une fiche
              n&apos;apparaît ici que si l&apos;image exacte, le stock,
              le prix, le délai et la marge sont suffisamment vérifiés.
            </p>
          </div>
        )}
      </section>
