...
La commande `catalog:audit-daily-execution-board` controle ce tableau avant de s'y fier: mode lecture seule, garde-fous sensibles, absence d'URL externe ou marqueur marketplace, actions images qui rappellent l'interdiction de copie publique/publication/commande, coherence pipeline images publiques OK, sources catalogue publiques filtrees OK, surface visuelle publique OK, SEO produits HOLD OK, compteurs surface publique/checkout/surprises et copie image publique non appliquee.
