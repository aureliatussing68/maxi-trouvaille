...
const quickSignals = [
  {
    ...
    text: "Sélection préparée avec validation humaine.",
  },
  {
    icon: ShieldCheck,
    title: "Achat clair",
    ...
    <>
        ...
        <div className="container-page relative flex min-h-[calc(100svh-4rem)] items-center py-14">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-xl font-black leading-8 text-white/92 sm:text-2xl">
              Bonnes affaires, produits utiles et nouveautés partenaires.
            </p>
      ...
      <section className="container-page py-10">
        <div className="mb-6">
          ...
          <h2 className="mt-2 text-2xl font-black">Catégories à fort potentiel</h2>
        </div>
