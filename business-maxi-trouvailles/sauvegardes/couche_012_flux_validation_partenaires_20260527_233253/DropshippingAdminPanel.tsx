...
export function DropshippingAdminPanel({
  ...
  const [message, setMessage] = useState("Mode semi-automatique actif.");
      ...
      <section className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Field name="supplierUrl" label="Lien fournisseur" required />
            <Field name="supplierSku" label="SKU fournisseur" />
            <Field name="title" label="Titre produit" required />
            <label className="grid gap-2 text-sm font-bold">
              Catégorie
              <select
                name="categoryId"
                className="focus-ring min-h-12 rounded-md border border-line px-3 text-base"
                defaultValue="dropshipping-nouveautes"
              >
          ...
          <label className="grid gap-2 text-sm font-bold">
            ...
            <textarea
              ...
              placeholder="Texte visible par le client, sans mention AliExpress."
            />
          </label>
