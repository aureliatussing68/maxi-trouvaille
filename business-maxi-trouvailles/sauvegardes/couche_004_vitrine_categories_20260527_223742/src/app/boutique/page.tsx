        ...
        <div className="mb-6 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-black">
              Produits partenaires & nouveautés
            </h2>
          </div>
          <Link
            href="/categories"
      ...
      <section className="container-page py-10">
        <div className="mb-7 rounded-lg border border-line bg-paper p-5 shadow-sm">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
            Les produits partenaires affichent une livraison estimée et restent
            traités manuellement au début. Les fiches en brouillon restent en
