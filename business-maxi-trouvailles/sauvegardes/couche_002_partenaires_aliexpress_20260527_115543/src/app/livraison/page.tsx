...
import { Handshake, MapPin, PackageCheck, Route, Truck } from "lucide-react";
  ...
  return (
    <>
      <PageHeader
        ...
        description="Maxi Trouvaille propose des options simples, avec une base prête pour le suivi colis et les expéditions par partenaire logistique."
      />
      <section className="container-page grid gap-5 py-10 md:grid-cols-2">
        ...
        <article className="rounded-lg border border-line bg-paper p-6 shadow-sm">
          <Route className="mb-4 text-teal" size={28} aria-hidden="true" />
          <h2 className="text-xl font-black">Produits partenaires</h2>
          <p className="mt-3 text-sm leading-6 text-muted">
            Les produits dropshipping affichent un délai estimé propre. Le suivi
            colis sera ajouté dès que le partenaire confirme l&apos;expédition.
          </p>
        </article>
      </section>
    </>
