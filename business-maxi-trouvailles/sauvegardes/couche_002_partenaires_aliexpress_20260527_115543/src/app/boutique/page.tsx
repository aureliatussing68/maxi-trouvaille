...
export const metadata: Metadata = {
  title: "Boutique",
  description:
    "Arrivages Maxi Trouvaille : produits personnels, dropshipping, promotions, nouveautes et futurs colis surprises.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Découvrez les produits personnels, les produits dropshipping partenaires, les promotions et les futurs colis surprises. Les colis/palettes sont visibles mais pas encore vendus."
      />
      ...
      <section className="container-page py-10">
        <div className="mb-7 rounded-lg border border-line bg-paper p-5 shadow-sm">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
            Les produits dropshipping affichent une livraison estimée et restent
            traités manuellement au début. Les colis surprises et palettes sont
            marqués À venir tant que le système n&apos;est pas ouvert.
          </p>
        </div>
