...
- OK over_stock_quantity: API rejects quantity above product stock - Route compares requested quantity to product.stock.
...
- OK live_payment_flag: Live Stripe mode requires explicit enable flag - Route requires STRIPE_ENABLE_LIVE_PAYMENTS for live secret keys.
