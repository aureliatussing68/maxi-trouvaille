...
export function ProductCard({
  ...
  const canRenderPublicProduct = showAdminControls || isPublicProduct(product);
    ...
    return (
      <article className="overflow-hidden rounded-lg border border-dashed border-line bg-[#faf7f0] shadow-sm">
        <div className="flex aspect-[4/3] items-center justify-center bg-[#f1eadf] p-5 text-center">
          <span className="rounded-md border border-[#fed7aa] bg-[#fff7ed] px-3 py-2 text-sm font-black text-[#9a3412]">
            Fiche en validation
          </span>
        </div>
        <div className="grid gap-3 p-4">
          ...
          <p className="text-sm leading-6 text-muted">
            Photo, fournisseur, stock, délai et validation humaine doivent être
            confirmés avant affichage public.
          </p>
        </div>
      </article>
    );
