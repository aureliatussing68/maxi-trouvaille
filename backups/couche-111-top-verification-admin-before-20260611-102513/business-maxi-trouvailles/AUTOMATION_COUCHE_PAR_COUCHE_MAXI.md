...
La page admin `Preuves partenaires` permet de rechercher les fiches HOLD par nom, slug, categorie ou statut, puis d'exporter le resultat filtre en CSV terrain sans modifier le catalogue.
