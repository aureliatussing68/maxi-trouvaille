...
function checks(formSource, proofsPageSource, pilotagePageSource, routeSource) {
  return [
    ...
    },
    {
      ...
      failure: "La page preuves partenaires doit afficher un lot terrain du jour avec 3 fiches HOLD compactes, un etat visuel image/marge/delai, un export CSV dedie et un lien filtre vers chaque fiche terrain.",
    },
    {
