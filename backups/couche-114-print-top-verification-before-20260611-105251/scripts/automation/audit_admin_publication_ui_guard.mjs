...
function checks(formSource, proofsPageSource, routeSource) {
  return [
    ...
    },
    {
      ...
      failure: "La page preuves partenaires doit afficher un classement des produits HOLD a verifier en priorite, l'exporter en CSV court et fournir une mini fiche terrain.",
    },
