...
- Scan anti-secret sur les fichiers et artefacts texte de couche.
...
- Scan anti-secret: seule occurrence attendue dans la doc: `Ne jamais copier de secret/API/token dans un rapport.`
