...
function checks(formSource, proofsPageSource, pilotagePageSource, routeSource) {
  return [
    ...
    },
    {
      ...
      failure: "La page preuves partenaires doit proposer une recherche par URL, filtrer les listes HOLD par statut et zone de preuve, afficher un sprint zone active avec export CSV dedie et exporter le CSV filtre.",
    },
    {
    ...
    },
    {
      ...
      failure: "La page pilotage doit afficher le recap HOLD du jour avec top verification, zone prioritaire du jour, export CSV, impression, prochain produit a verifier et liens filtres vers les preuves terrain.",
    },
