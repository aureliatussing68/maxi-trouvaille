  ...
  return (
    <>
      ...
      <section className="container-page grid gap-8 py-10">
          ...
          <section className="rounded-lg border border-line bg-paper p-5 shadow-sm">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div className="min-w-0">
                ...
                <h2 className="mt-2 text-2xl font-black">
                  {data.fastProofNow.productCount} produits rapides,{" "}
            ...
            <div className="mt-5 grid gap-3 lg:grid-cols-5">
              {data.fastProofNow.products.map((product) => (
                <article
                  key={product.id}
        ...
        {data.quickProofAnchors.length > 0 ? (
          <section className="rounded-lg border border-line bg-paper p-5 shadow-sm">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div>
                <p className="text-sm font-black uppercase text-teal">
                ...
                <h2 className="mt-2 text-2xl font-black">
                  {data.quickProofAnchors.length} fiches partenaires a raccorder
                </h2>
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
              {data.quickProofAnchors.map((product) => (
                <article
                  key={product.id}
          ...
          <section className="rounded-lg border border-line bg-paper p-5 shadow-sm">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div className="min-w-0">
                ...
                <h2 className="mt-2 text-2xl font-black">
                  {data.fastProofNowAudit.holdCount} HOLD,{" "}
            ...
            <div className="mt-5 grid gap-3 lg:grid-cols-5">
              {data.fastProofNowAudit.products.map((product) => (
                <article
                  key={product.id}
