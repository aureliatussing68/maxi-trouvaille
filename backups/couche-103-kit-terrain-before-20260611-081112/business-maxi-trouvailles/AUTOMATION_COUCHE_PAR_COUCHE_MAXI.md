...
2. Branche Catalogue rentable
   ...
   - Commandes cles: `npm run catalog:prepare-draft-backlog`, `npm run catalog:fast-proof-now-export`, `npm run catalog:audit-fast-proof-now-export`, `npm run catalog:single-product-cockpit`, `npm run catalog:product-cockpits-batch`.
