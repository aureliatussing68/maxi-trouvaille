...
export function OrderSuccess({ sessionId }: { sessionId?: string }) {
  ...
  const [reviewMessage, setReviewMessage] = useState(
    "Le lien d'avis sera disponible apres validation du paiement.",
  );
    ...
    <div className="container-page py-12">
      <div className="rounded-lg border border-line bg-paper p-8 text-center shadow-sm">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-muted">
          Votre panier a ete vide. Vous recevrez les informations de suivi des
          que la commande sera traitee.
        </p>
