...
function guardrailActions({ checkout, partnerGates, surprise }) {
  return [
    {
      lane: "garde_fous",
      urgency: 900,
...
function markdown(summary) {
  ...
  return `${[
    ...
    `- Produits achetables attendus: ${summary.metrics.expectedPurchasableCount}`,
    "- Publication: aucune",
...
const actions = [
  ...
  ...guardrailActions({ checkout, partnerGates, surprise }),
]
