...
La page admin `Preuves sourcing` ouvre un atelier lecture seule dedie aux prochaines preuves sourcing: ordre de traitement, etats d'audit rediges, formats attendus, motifs de rejet, depot image exacte, exports CSV rediges/template et lien retour `Pilotage`. Elle ne rend pas les valeurs fournisseur brutes, ne modifie pas le catalogue et garde le statut HOLD jusqu'aux audits OK et validation humaine Mouss.
