...
export function QuickProductImportForm() {
  ...
  async function saveProduct(shouldContinue: boolean) {
    ...
    try {
      ...
      setMessage(`Brouillon HOLD ajoute : ${data.product.name}`);
  ...
  return (
    <div className="container-page grid gap-6 py-10 lg:grid-cols-[minmax(0,1fr)_380px]">
      <form
      ...
      >
        <div className="flex items-start gap-3 rounded-lg bg-[#eef8f6] p-4 text-sm leading-6 text-[#115e59]">
          ...
          <p>
            ...
            Chaque ajout reste en brouillon/HOLD jusqu aux preuves image exacte.
          </p>
        </div>
        ...
        <label className="grid min-w-0 gap-2 text-sm font-bold">
          ...
          <input
            ...
            className="focus-ring min-h-12 w-full min-w-0 rounded-md border border-line px-3 text-base"
        ...
        <label className="grid min-w-0 gap-2 text-sm font-bold">
          ...
          <textarea
            ...
            rows={4}
            className="focus-ring w-full min-w-0 rounded-md border border-line px-3 py-3 text-base"
