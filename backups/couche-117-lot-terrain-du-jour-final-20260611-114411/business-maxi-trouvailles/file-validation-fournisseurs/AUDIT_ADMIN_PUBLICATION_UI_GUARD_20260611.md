...
| proof_page_daily_terrain_lot_present | OK | La page preuves partenaires doit afficher un lot terrain du jour avec 3 fiches HOLD compactes et un lien filtre vers chaque fiche terrain. |
