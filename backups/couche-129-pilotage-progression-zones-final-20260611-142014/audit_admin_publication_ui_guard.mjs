...
function checks(formSource, proofsPageSource, pilotagePageSource, routeSource) {
  return [
    ...
    },
    {
      ...
      failure: "La page pilotage doit afficher le recap HOLD du jour avec top verification, progression des zones preuves, zone prioritaire du jour, sprint preuves terrain, export CSV, impression, prochain produit a verifier et liens filtres vers les preuves terrain.",
    },
