...
Date locale: 2026-06-11 12:17 Europe/Paris
...
| proof_page_daily_terrain_lot_present | OK | La page preuves partenaires doit afficher un lot terrain du jour avec 3 fiches HOLD compactes, un etat visuel image/marge/delai, une prochaine action terrain, un export CSV dedie et un lien filtre vers chaque fiche terrain. |
| pilotage_hold_today_summary_present | OK | La page pilotage doit afficher le recap HOLD du jour avec top verification, export CSV, impression, prochain produit a verifier et lien filtre vers sa fiche terrain. |
