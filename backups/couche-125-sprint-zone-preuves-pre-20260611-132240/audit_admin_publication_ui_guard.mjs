...
function checks(formSource, proofsPageSource, pilotagePageSource, routeSource) {
  return [
    ...
    },
    {
      ...
      failure: "La page preuves partenaires doit proposer une recherche par URL, filtrer les listes HOLD par statut et zone de preuve, puis exporter le CSV filtre.",
    },
    {
