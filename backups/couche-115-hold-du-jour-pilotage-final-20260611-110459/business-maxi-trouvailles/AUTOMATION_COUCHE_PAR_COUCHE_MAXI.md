...
La page admin `Pilotage` affiche un recap `HOLD du jour`: nombre de fiches partenaires a prouver, top verification pret, CSV court pret, impression prete et prochain produit a verifier. Elle reste une vue de pilotage, sans publication, paiement ni commande fournisseur.
