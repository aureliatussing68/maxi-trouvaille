...
const items = [
  {
    ...
    text: "Selection dropshipping controlee avant mise en vente.",
  },
  {
    icon: ShieldCheck,
    title: "Achat encadre",
    text: "Paiement securise et validation humaine au lancement.",
  },
  {
    icon: Truck,
    title: "Livraison suivie",
    text: "Delais estimes et suivi colis cote Maxi Trouvaille.",
  },
  {
    icon: BadgeEuro,
    title: "Prix clairs",
    text: "Prix, livraison et suivi controles avant mise en vente.",
  },
];
