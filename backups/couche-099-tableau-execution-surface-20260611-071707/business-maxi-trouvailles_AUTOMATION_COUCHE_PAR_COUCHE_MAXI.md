...
2. Branche Catalogue rentable
   ...
   - Commandes cles: `npm run catalog:prepare-draft-backlog`, `npm run catalog:fast-proof-now-export`, `npm run catalog:audit-fast-proof-now-export`.
...
3. Branche Confiance, mobile, checkout
   ...
   - Commandes cles: `npm run catalog:audit-public-dropshipping-surface`, `npm run catalog:audit-checkout-eligibility`, `npm run catalog:test-checkout-guards`, `npm run build`.
...
La commande `catalog:daily-execution-board` rassemble les actions du jour: preuves produits partenaires, depots images categories, photos produits sprint et garde-fous checkout/publication/surprises. Elle reste en lecture seule et sert de tableau priorise d'execution.
