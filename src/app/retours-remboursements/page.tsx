        ...
        <section className="grid gap-5 md:grid-cols-2">
          <article className="rounded-lg border border-line bg-[#faf7f0] p-6 shadow-sm md:col-span-2">
            ...
            <ol className="mt-4 grid max-w-3xl gap-3 text-sm leading-6 text-muted">
              <li>
                <span className="font-black text-foreground">1.</span> Contactez
                le service client (email{" "}
                <a
              ...
              <li>
                <span className="font-black text-foreground">2.</span> Nous vous
                confirmons la marche à suivre et l&apos;adresse de retour. Le
                produit doit être renvoyé complet, si possible dans son
                emballage d&apos;origine.
              </li>
              <li>
                <span className="font-black text-foreground">3.</span> Après
                réception et vérification du produit, le remboursement est
          ...
          <article className="rounded-lg border border-line bg-paper p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-muted">
              Vous disposez d&apos;un délai légal de 14 jours à compter de la
              réception de votre commande pour exercer votre droit de
              rétractation, sans avoir à vous justifier et sans pénalité. Les
              modalités complètes et le formulaire type figurent sur la page{" "}
              <a className="underline" href="/retractation">
