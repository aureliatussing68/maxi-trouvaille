...
export type DropshippingOrderStockDecrementStatus =
  | "pending-payment"
  | "done"
  | "skipped"
  | "failed";
...
export type DropshippingOrder = {
  ...
  stockDecrementStatus?: DropshippingOrderStockDecrementStatus;
  stockDecrementedAt?: string;
  stockDecrementSource?: "stripe-webhook";
  stockDecrementLineCount?: number;
  stockDecrementError?: string;
