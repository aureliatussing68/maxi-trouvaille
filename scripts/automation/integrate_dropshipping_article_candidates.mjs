...
const candidateSeeds = [
  ...
  {
    key: "boite-a-the-compartiments-bambou",
    name: "Boite a the compartiments bambou",
    categoryId: "dropshipping-cuisine",
    targetSalePriceCents: 1890,
    estimatedSupplierPriceCents: 720,
    deliveryTarget: "Stock Europe a verifier",
    angle: "Rangement cuisine cadeau utile, valeur percue correcte et produit facile a comprendre.",
    proofEffort: "Verifier dimensions, nombre de compartiments, matiere, fermeture et photos exactes.",
  },
  {
    key: "porte-cles-mural-adhesif",
    name: "Porte cles mural adhesif",
    categoryId: "dropshipping-maison",
    targetSalePriceCents: 1190,
    estimatedSupplierPriceCents: 330,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Petit rangement entree, besoin clair, panier additionnel maison simple.",
    proofEffort: "Verifier adhesif, dimensions, nombre de crochets, charge et photo exacte.",
  },
  {
    key: "tapis-repas-chat-silicone",
    name: "Tapis repas chat silicone",
    categoryId: "dropshipping-animaux",
    targetSalePriceCents: 1290,
    estimatedSupplierPriceCents: 390,
    deliveryTarget: "France/Europe a verifier",
    angle: "Produit animal propre et recurrent, utile pour gamelles et nettoyage rapide.",
    proofEffort: "Verifier matiere, dimensions, rebords, couleur et photos exactes.",
  },
  {
    key: "support-casque-bureau-adhesif",
    name: "Support casque bureau adhesif",
    categoryId: "dropshipping-accessoires",
    targetSalePriceCents: 990,
    estimatedSupplierPriceCents: 250,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Accessoire bureau/gaming simple, faible prix, bon ajout panier.",
    proofEffort: "Verifier fixation, charge supportee, matiere, couleur et photo exacte.",
  },
  {
    key: "organisateur-frigo-transparent",
    name: "Organisateur frigo transparent",
    categoryId: "dropshipping-cuisine",
    targetSalePriceCents: 1590,
    estimatedSupplierPriceCents: 570,
    deliveryTarget: "Entrepot Europe a verifier",
    angle: "Rangement frigo tres visuel, usage quotidien et valeur percue correcte.",
    proofEffort: "Verifier dimensions, matiere contact alimentaire, nombre de pieces et photos exactes.",
  },
  {
    key: "brosse-ventilation-voiture",
    name: "Brosse ventilation voiture",
    categoryId: "dropshipping-auto-moto",
    targetSalePriceCents: 890,
    estimatedSupplierPriceCents: 190,
    deliveryTarget: "France/Europe a verifier",
    angle: "Petit accessoire auto demonstratif, utile pour nettoyage interieur et achat impulsif.",
    proofEffort: "Verifier forme, matiere, lot exact, compatibilite usage et photos exactes.",
  },
  {
    key: "pochette-cable-voyage-electronique",
    name: "Pochette cable voyage electronique",
    categoryId: "dropshipping-accessoires",
    targetSalePriceCents: 1390,
    estimatedSupplierPriceCents: 430,
    deliveryTarget: "France/Europe 5 a 12 jours a verifier",
    angle: "Organisation voyage/bureau, produit simple et coherent avec accessoires tech.",
    proofEffort: "Verifier dimensions, poches, fermeture, coloris et photo de la variante.",
  },
  {
    key: "support-ordinateur-portable-pliable",
    name: "Support ordinateur portable pliable",
    categoryId: "dropshipping-high-tech",
    targetSalePriceCents: 1990,
    estimatedSupplierPriceCents: 820,
    deliveryTarget: "Entrepot Europe a verifier",
    angle: "Accessoire teletravail avec valeur percue, usage clair et faible complexite SAV.",
    proofEffort: "Verifier taille compatible, inclinaison, matiere, charge et photos exactes.",
  },
  {
    key: "mini-balai-table-ramasse-miettes",
    name: "Mini balai table ramasse miettes",
    categoryId: "dropshipping-cuisine",
    targetSalePriceCents: 990,
    estimatedSupplierPriceCents: 240,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Produit nettoyage cuisine visible, petit prix et usage quotidien.",
    proofEffort: "Verifier dimensions, reservoir, couleur, fonctionnement et photos exactes.",
  },
  {
    key: "boite-rangement-medicaments-vide",
    name: "Boite rangement medicaments vide",
    categoryId: "dropshipping-maison",
    targetSalePriceCents: 1690,
    estimatedSupplierPriceCents: 610,
    deliveryTarget: "Stock Europe a verifier",
    angle: "Rangement maison utile, sans contenu sensible, valeur percue correcte.",
    proofEffort: "Verifier dimensions, compartiments, fermeture, etiquette et photos exactes.",
  },
  {
    key: "sac-filet-linge-delicat-lot",
    name: "Sac filet linge delicat lot",
    categoryId: "dropshipping-maison",
    targetSalePriceCents: 990,
    estimatedSupplierPriceCents: 220,
    deliveryTarget: "France/Europe a verifier",
    angle: "Produit entretien simple, achat rationnel et bon complement panier.",
    proofEffort: "Verifier nombre de sacs, tailles, fermeture, maille et photo exacte du lot.",
  },
  {
    key: "cable-organizer-boite-multiprise",
    name: "Cache multiprise boite rangement cables",
    categoryId: "dropshipping-accessoires",
    targetSalePriceCents: 1890,
    estimatedSupplierPriceCents: 760,
    deliveryTarget: "Entrepot Europe a verifier",
    angle: "Organisation bureau/salon, probleme clair et bon potentiel visuel avant/apres.",
    proofEffort: "Verifier dimensions, ventilation, matiere, coloris et photos exactes.",
  },
  {
    key: "grattoir-vitroceramique-cuisine",
    name: "Grattoir vitroceramique cuisine",
    categoryId: "dropshipping-cuisine",
    targetSalePriceCents: 1090,
    estimatedSupplierPriceCents: 310,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Produit nettoyage cuisine utile, demonstration facile et faible encombrement.",
    proofEffort: "Verifier lame fournie, securite, lot exact, materiau et photos exactes.",
  },
  {
    key: "organisateur-coffre-voiture-pliable",
    name: "Organisateur coffre voiture pliable",
    categoryId: "dropshipping-auto-moto",
    targetSalePriceCents: 2490,
    estimatedSupplierPriceCents: 1120,
    deliveryTarget: "Stock Europe a verifier",
    angle: "Produit auto rangement a panier moyen plus eleve, usage familial clair.",
    proofEffort: "Verifier dimensions, compartiments, poignees, matiere et photos exactes.",
  },
  {
    key: "porte-brosse-a-dents-adhesif",
    name: "Porte brosse a dents adhesif",
    categoryId: "dropshipping-maison",
    targetSalePriceCents: 1190,
    estimatedSupplierPriceCents: 320,
    deliveryTarget: "France/Europe a verifier",
    angle: "Rangement salle de bain simple, petit prix, compatible bundles maison.",
    proofEffort: "Verifier fixation, nombre d'emplacements, drainage, couleur et photos exactes.",
  },
  {
    key: "trousse-premiers-soins-vide-voyage",
    name: "Trousse premiers soins vide voyage",
    categoryId: "dropshipping-accessoires",
    targetSalePriceCents: 1290,
    estimatedSupplierPriceCents: 360,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Pochette voyage vide, utile en organisation sans vente de produit medical.",
    proofEffort: "Verifier qu'elle est vendue vide, dimensions, compartiments, coloris et photos exactes.",
  },
  {
    key: "gant-brossage-animaux-silicone",
    name: "Gant brossage animaux silicone",
    categoryId: "dropshipping-animaux",
    targetSalePriceCents: 1290,
    estimatedSupplierPriceCents: 360,
    deliveryTarget: "Entrepot Europe a verifier",
    angle: "Accessoire entretien animal demonstratif, simple a expliquer et panier additionnel.",
    proofEffort: "Verifier taille, main droite/gauche, picots, matiere et photos exactes.",
  },
  {
    key: "support-eponges-evier-ventouse",
    name: "Support eponges evier ventouse",
    categoryId: "dropshipping-cuisine",
    targetSalePriceCents: 890,
    estimatedSupplierPriceCents: 180,
    deliveryTarget: "France/Europe 5 a 10 jours a verifier",
    angle: "Petit rangement evier, besoin quotidien, faible prix et facile a packager.",
    proofEffort: "Verifier ventouse, matiere, drainage, dimensions et photo exacte du modele.",
  },
];
