  ...
  return [
    ...
    },
    {
      ...
      ok:
        ...
        pilotagePageSource.includes("Production visuels exacts") &&
        pilotagePageSource.includes("readLatestVisualProductionBoard") &&
        pilotagePageSource.includes("collectVisualProductionBoardFiles") &&
        pilotagePageSource.includes("VisualProductionBoard") &&
        pilotagePageSource.includes("buildVisualProductionBoardCsv") &&
        pilotagePageSource.includes("visualProductionExportHref") &&
        pilotagePageSource.includes("visualProductionExportFilename") &&
        pilotagePageSource.includes("maxi-production-visuels-exacts.csv") &&
        pilotagePageSource.includes("Exporter visuels exacts CSV") &&
        pilotagePageSource.includes("VISUELS_EXACTS_A_PRODUIRE_") &&
        pilotagePageSource.includes("Alerte production visuels") &&
        pilotagePageSource.includes("visuels a produire maintenant") &&
